...
/*   Updated: 2025/02/10 08:34:09 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	These functions are helper function that may be used in multiple files.
*	They are used to compare strings, tokenize strings and check if a command is a builtin.
*/
