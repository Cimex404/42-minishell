...
/*   Updated: 2025/02/10 08:35:51 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	These functions are used to built a path matching the command.
*	It takes the PATH environment variable and the command and builds a path.
*	If the command can be found in the PATH and be executed, the function returns the path.
