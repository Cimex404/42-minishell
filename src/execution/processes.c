...
/*   Updated: 2025/02/10 08:47:17 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	These functions are used to handle the processes.
*	They are used to free the command array, execute the child process and handle the parent process.
*/
