...
/*   Updated: 2025/02/10 08:13:16 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
*	This is the custom implementation of the unset command.
*	Unset is the exact opposite of export.
*	Unset is used to remove environment variables.
*	If you try to unset a variable that does not exist, it will not do anything.
*/
