...
/*   Updated: 2025/02/10 08:55:25 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	These function are used to replace the environment variables in the input.
*	The input is copied until a $ is found. If that $ is not inside a single quote,
*	then the variable is replaced with the value of the environment variable.
*	If the $ is inside a single quote, then the variable is not replaced.
*	Also, if the $ is followed by a ?, then the last status of the program is returned.
*/
