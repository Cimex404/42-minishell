...
/*   Updated: 2025/02/10 08:56:23 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	This is the tokenisation system of the program.
*	Essentially, it takes the input and splits it into tokens.
*	Tokens are mostly split by spaces and tabs, but this does not apply to quoted sequences.
*	For all tokens, we asign a type, which is used to determine special cases like redirections and pipes.
*	All tokens are trimmed of whitespace and the environment variables are replaced.
*	Lastly, the tokens are trimmed of double and single quotes.
*/
