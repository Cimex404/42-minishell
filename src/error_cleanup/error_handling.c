...
/*   Updated: 2025/02/10 08:21:46 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	These functions are the heart of the error handling of this program.
*	The applicable error code is returned and an appropriate error message is printed.
*	Memory error are handled as fatal errors and seen as a crash of the program.
*/
