...
/*   Updated: 2025/02/10 08:19:58 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	These functions are used to clean up the program in case of exit or error.
*	All tokens, heredoc files and environment variables are freed.
*	Also, the program is exited with the correct status code if the user uses the exit command.
*/
