...
/*   Updated: 2025/02/10 08:19:11 by jgraf            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/*	These functions are used to update the environment variables.
*	They look if the variable is set, and if it is, it will be replaced with the new value.
*	If the variable is not set, it will be added to the environment variables.
*/
